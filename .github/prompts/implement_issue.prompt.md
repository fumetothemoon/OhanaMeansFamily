...
4. Identify missing details, contradictory requirements, risky assumptions, or unrelated changes already in the working tree.
...
2. Create a descriptive branch from the current branch. Use a lowercase, hyphenated branch name based on the issue, such as `fix/123-weekly-reminder-duplicates` or `feature/123-add-reminder-command`.
